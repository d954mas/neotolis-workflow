...
test('release artifacts contain exactly the approved inventories and no links', () => {
  ...
  assert.deepEqual(filesUnder(CLAUDE_MARKETPLACE), [
    ...
    'plugins/neotolis-workflow/agents/ntwork-code-reviewer.md',
    'plugins/neotolis-workflow/agents/ntwork-implementer.md',
    'plugins/neotolis-workflow/agents/ntwork-nyquist-auditor.md',
    'plugins/neotolis-workflow/agents/ntwork-spec-integration-reviewer.md',
    'plugins/neotolis-workflow/agents/ntwork-task-reviewer.md',
    ...
    'plugins/neotolis-workflow/skills/ntwork/SKILL.md',
  ]);
  assert.deepEqual(filesUnder(CODEX_MARKETPLACE), [
    ...
    'plugins/neotolis-workflow/agents/ntwork_code_reviewer.toml',
    'plugins/neotolis-workflow/agents/ntwork_implementer.toml',
    'plugins/neotolis-workflow/agents/ntwork_nyquist_auditor.toml',
    'plugins/neotolis-workflow/agents/ntwork_spec_integration_reviewer.toml',
    'plugins/neotolis-workflow/agents/ntwork_task_reviewer.toml',
    'plugins/neotolis-workflow/hooks/hooks.json',
    'plugins/neotolis-workflow/runtime/ntworkflow.mjs',
    'plugins/neotolis-workflow/runtime/session-start.mjs',
    'plugins/neotolis-workflow/skills/ntgrill/LICENSE',
